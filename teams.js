...
const pointRadius = 2;  // Size of points
const transitionSpeed = 0.000005;  // Slow down point movement
const lineFormationDelay = 200; // 2-second delay for line formation
const hoverRadius = 200; // Increased radius of the region around the mouse
const lineDuration = 200; // Duration for which the lines stay visible

let mouseX = -1000, mouseY = -1000; // Initial mouse position (out of bounds)
let lines = [];
